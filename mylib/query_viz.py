...
def query_transform():
    ...
    query = (
        "SELECT t1.id, t1.server, t1.seconds_before_next_point, t1.day, t1.opponent, t1.game_score, t1.set,"
        ...
        "GROUP BY t1.id, t1.server, t1.seconds_before_next_point, t1.day, t1.opponent, t1.game_score,"
        "t1.set, t1.game, t2.tournament, t2.surface, t2.seconds_added_per_point, t2.years"
...
def viz():
    ...
    query.select('seconds_before_next_point', 
                 'server').toPandas().boxplot(column='seconds_before_next_point', 
                                              by='server')
    plt.xlabel('Server')
    ...
    plt.bar(df_surface_avg['surface'], 
